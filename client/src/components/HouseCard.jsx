...
const HouseCard = ({ house = {}, isSaved = false, toggleSaveHouse, user }) => {
  ...
  const title = house.title || "Townname, State";
  const price = house.price || "--";
  const description = house.description || "This is where we will display search results for housing options hehehehe.";
    ...
    >
      ...
      <div className="bg-white rounded-b-lg p-6 shadow-md h-auto">
        <div className="flex justify-between">
          ...
          <span className="text-[#4E674A] font-semibold">${price}/mo</span>
        </div>
        
        <p className="text-[#4E674A]/70 mb-2">
          {description}
        </p>
